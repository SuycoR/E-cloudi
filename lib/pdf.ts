...
/**
 * Genera un PDF de boleta usando PDFKit con estilo corporativo de ecloudi.
 */
export async function generarBoletaPDF(
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.registerFont(
      "Roboto",
      path.join(fontsDir, "Roboto-VariableFont_wdth,wght.ttf")
    );
    doc.registerFont(
      "Roboto-Italic",
      path.join(fontsDir, "Roboto-Italic-VariableFont_wdth,wght.ttf")
    );
    ...
    doc
      ...
      .font("Roboto")
      .fontSize(20)
      .text("ECLOUDI - BOLETA DE VENTA", 140, titleY);
    ...
    doc
      ...
      .text(`Fecha: ${fecha} ${hora}`, doc.page.width - 150, titleY + 20, {
        align: "right",
      });
    ...
    doc
      .roundedRect(50, clientY, doc.page.width - 100, 60, 5)
      .fill(colors.ebony50);
    doc
    ...
    doc
      .roundedRect(50, addressY, doc.page.width - 100, 160, 5)
      .fill(colors.ebony50);
    doc
      .fillColor(colors.ebony900)
      .font("Roboto-Italic")
    ...
    doc
      .roundedRect(50, detailsY, doc.page.width - 100, 80, 5)
      .fill(colors.ebony50);
    doc
      .fillColor(colors.ebony900)
      .font("Roboto-Italic")
    ...
    items.forEach((item, i) => {
      if (i % 2 === 0)
        doc.rect(50, rowY - 2, doc.page.width - 100, 20).fill(colors.ebony100);
    ...
    doc
      .roundedRect(50, afterTableY, doc.page.width - 100, 60, 5)
      .stroke(colors.ebony200);
    doc
      .font("Roboto-Italic")
      .fontSize(10)
    ...
    doc
      ...
      .fontSize(12)
      .text(`S/ ${total.toFixed(2)}`, doc.page.width - 150, afterTableY + 40, {
        align: "right",
      });
    ...
    doc
      ...
      .fontSize(8)
      .text(
        "Tlf: +51 999 999 999 • correo: ecloudi.services@gmail.com • web: ecloudi.com.pe • Instagram: @ecloudi",
        50,
        footerY + 10,
